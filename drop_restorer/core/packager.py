...
def installation_instructions(theme_name='wordpress-theme.zip', content_name='content.xml'):
    return ('# Установка восстановленного сайта\n\n'
        ...
        '6. Проверьте все архивные пути, три казино-страницы и /go/ на установленном домене. Превью не проверяет правила вашего хостинга. Если остаётся Apache 404, проверьте WordPress-правила .htaccess и AllowOverride/mod_rewrite; для Nginx — передачу отсутствующих путей в index.php. Контент и метаданные казино редактируются владельцем; canonical уже задан.\n'
